...
public class TensorUtils {
    ...
    public static void sub(double[] arr, double val) {
    ...
    public static Tensor absMax(final Tensor t, final Tensor max) {
        final double[] tValues = t.getValues();
        final double[] maxValues = max.getValues();
     ...
     * @return
     */
    public static double[] absMax(final double[] arr, final double[] max) {
    ...
    public static Tensor absMin(final Tensor t, final Tensor min) {
        final double[] tValues = t.getValues();
        final double[] minValues = min.getValues();
    ...
    public static double[] absMin(final double[] arr, final double[] min) {
        for (int i = 0; i < arr.length; i++) {
    ...
    public static void div(final double[] array, final double val) {
        for (int i = 0; i < array.length; i++) {
            array[i] /= val;
        }
    }

    public static void div(final double[] array, final double[] divisor) {
        for (int i = 0; i < array.length; i++) {
            array[i] = array[i] / divisor[i];
        }
    }

    public static final void sub(final double[] array1, final double[] array2) {
        for (int i = 0; i < array1.length; i++) {
            array1[i] -= array2[i];
        }
    }

    public static final void add(final double[] array1, final double[] array2) {
        for (int i = 0; i < array1.length; i++) {
            array1[i] += array2[i];
        }
    }
