...
public class Goldstein extends LossFunction {
    ...
    public Variable[] forward(Variable... xs) {
        ...
        loss[0] = parameter(1, xs[0].getShape()).plus(xs[0].plus(xs[1]).plus(parameter(1, shape)).pow(2).multiply(parameter(19, xs[0].getShape()).minus(parameter(14, xs[0].getShape()).multiply(xs[0])).plus(parameter(3, xs[0].getShape()).multiply(xs[0].pow(2))).minus(parameter(14, xs[0].getShape()).multiply(xs[1])).plus(parameter(6, xs[0].getShape()).multiply(xs[0]).multiply(xs[1])).plus(parameter(3, xs[0].getShape()).multiply(xs[1].pow(2))))).multiply(parameter(30, xs[0].getShape()).plus(parameter(2, xs[0].getShape()).multiply(xs[0]).minus(parameter(3, xs[0].getShape()).multiply(xs[1])).pow(2).multiply(parameter(18, xs[0].getShape()).minus(parameter(32, xs[0].getShape()).multiply(xs[0])).plus(parameter(12, xs[0].getShape()).multiply(xs[0].pow(2))).plus(parameter(48, xs[0].getShape()).multiply(xs[1])).minus(parameter(36, xs[0].getShape()).multiply(xs[0]).multiply(xs[1])).plus(parameter(27, xs[0].getShape()).multiply(xs[1].pow(2))))));
        return loss;
    }
