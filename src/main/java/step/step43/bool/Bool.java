package step.step43.bool;


import step.step43.Variable;
...
public class Bool {
    ...
    public static void main(String[] args) {
        ...
        yArray[0] = new double[]{0, 0, 1, 1, 0};
        yArray[1] = new double[]{0, 1, 1, 0, 1};
        yArray[2] = new double[]{0, 1, 1, 0, 1};
        yArray[3] = new double[]{1, 1, 1, 0, 0};
        ...
        for (int i = 0; i < x.getShape()[0]; i++) {
            ...
            Variable y = predict(xi, w0, b0, w1, b1);
            System.out.println(xi.getValues()[0] + "\t" + xi.getValues()[1] + "\t" + y.getValues()[0] + "\t" + y0.getData().getValue(i, 0));
        }
